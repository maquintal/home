...
$BackupDirs="C:\Program Files (x86)\ChromisPos\lib\database", "C:\Users\vanaq\Documents\BeerSmith2" #What Folders you want to backup
...
$EmailSMTP = 'smtp.videotron.ca' #smtp server adress, DNS hostname.
